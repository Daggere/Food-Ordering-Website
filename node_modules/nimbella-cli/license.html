...
<head>
  ...
  <meta name="author" content="Version 2.0, January 2004" />
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-143782416-2"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());
  
    gtag('config', 'UA-143782416-2');
  </script>
  <script>
      (function(h,o,t,j,a,r){
          h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
          h._hjSettings={hjid:1726120,hjsv:6};
...
<p class="author">Version 2.0, January 2004</p>
<p class="date">http://www.apache.org/licenses/</p>
</header>
